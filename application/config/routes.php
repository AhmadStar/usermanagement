...
$route['groupListing'] = 'admin/groupListing';
...
$route['deleteGroup'] = "admin/deleteGroup";
...
$route['addNewGroup'] = "admin/addNewGroup";
$route['editGroup'] = "admin/editGroup";
$route['checkGroupExists'] = "admin/checkGroupExists";
