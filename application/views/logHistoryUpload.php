<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Backup Log Installation</small>
        </h1>
    </section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="role">Log Table</label>
                                            ...
                                            ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <p class="help-block">Choose backup from server or select file for backup installation</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
