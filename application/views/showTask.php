                                ...
                                <div class="mdb-lightbox">
                                    ...
                                    <?php foreach ($tasks_images as $image) { ?>
                                        <figure class="col-md-4">
                                            <a href="<?php echo base_url() . 'uploads/' . $image->name; ?>" data-size="1600x1067">
                                                <img alt="picture" src="<?php echo base_url() . 'uploads/' . $image->name; ?>" class="img-fluid" style="max-width: 200px">
                                            </a>
                                        </figure>
                                    <?php } ?>
