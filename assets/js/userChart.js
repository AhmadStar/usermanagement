...
$(function () {
  ...
  var labels = [];
  var values = [];
  var hitURL = baseURL + "getUserMonthHours";    
  $.ajax({
    async: false,
    url: hitURL,
    type: 'POST',      
    dataType: 'json',
    data: { userId : $( "canvas" ).attr("userChart")},
  ...
  userChartData.labels = labels;
  userChartData.datasets[0].data = values;  
